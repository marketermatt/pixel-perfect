...
function nk_woo_related_products_limit() {
...
add_filter( 'woocommerce_related_products_args', 'nk_woo_related_products_limit' );
...
if (!function_exists('wooframework_products_per_page')) {
    function wooframework_products_per_page() {
        ...
        if( isset( $azkaban_options['products_per_page'] ) ) {
            return $azkaban_options['products_per_page'];
        }
        else
            return 20;
    }
